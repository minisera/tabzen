...
| User settings (thresholds, domain rules, overlay size, etc.)                                                   | `chrome.storage.sync`  | Persist settings and sync via your Google account    | Until removed by the user                                      |
